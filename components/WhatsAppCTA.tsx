...
const WHATSAPP_NUMBER = "33753791617";
const WHATSAPP_MESSAGE = "Bonjour, je souhaite commander avec Clodia 🍽️";
...
export function WhatsAppButton({
  ...
  return (
    <a
      ...
      className="inline-flex items-center gap-2.5 font-semibold rounded-lg transition-all duration-200"
      style={{
        background: "var(--wa)",
        color: "#fff",
        padding: pad,
  ...
  return (
    <div className="flex flex-col items-center gap-3">
      <div
        ...
        style={{ background: "#fff", boxShadow: "0 4px 20px rgba(0,0,0,.08)" }}
      >
        <QRCodeSVG
          value={WHATSAPP_URL}
          size={180}
