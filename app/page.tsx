      ...
      <section className="relative min-h-screen flex items-center">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6 py-32 w-full">
          <div className="inline-flex items-center gap-2 bg-white/10 border border-white/20 rounded-full px-4 py-1.5 mb-8">
            <span className="w-2 h-2 rounded-full bg-[#EAFF33] inline-block" />
            <span className="text-white/80 text-xs font-medium tracking-widest uppercase">
              Chef récompensé Gault &amp; Millau
            </span>
          </div>
          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            <Link
              href="/whatsapp"
              className="bg-[#25D366] text-white text-sm px-7 py-3.5 rounded-full font-semibold hover:bg-[#1ebe57] transition-colors inline-flex items-center gap-2"
            >
